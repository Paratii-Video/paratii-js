...
describe('Paratii API:', function () {
  it('example session from ../docs/example-session.md should work', async function () {
    ...
    // await contracts.VideoStore.buyVideo('31415', { from : address})  // Error: invalid address // { from : 0x00000000000000000000000000000000000123455 }) // invalid address
    // await contracts.VideoStore.buyVideo('31415', { from : '0x00000000000000000000000000000000000123455'}) // Error: could not unlock signer address
