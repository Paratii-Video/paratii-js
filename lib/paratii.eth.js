...
export class ParatiiEth {
  ...
  async deployContracts () {
    ...
    let paratiiRegistryAddress = paratiiRegistry.contractAddress
    let paratiiAvatar = await this.deployContract('Avatar', paratiiRegistry.contractAddress)
    ...
    await paratiiRegistry.methods.registerAddress('Avatar', paratiiAvatar.contractAddress).send()
    await paratiiRegistry.methods.registerAddress('ParatiiToken', paratiiToken.contractAddress).send()
    await paratiiRegistry.methods.registerAddress('SendEther', sendEther.contractAddress).send()
    await paratiiRegistry.methods.registerAddress('Videos', videoRegistry.contractAddress).send()
    await paratiiRegistry.methods.registerAddress('Store', videoStore.contractAddress).send()
    await paratiiRegistry.methods.registerAddress('Users', userRegistry.contractAddress).send()
