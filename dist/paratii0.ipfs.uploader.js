  ...
  */
  ...
  (0, _createClass3.default)(ParatiiIPFSUploader, [{
    ...
    value: function pinFile(fileHash, options) {
      ...
      var schema = _joi2.default.object({
        author: _joi2.default.string().default('0x'), // ETH/PTI address of the file owner
        remoteIPFSNode: _joi2.default.string().default(this.config.ipfs.remoteIFPFSNode),
        remoteIPFSNodeId: _joi2.default.any().default(Multiaddr(this.config.ipfs.remoteIFPFSNode).getPeerId()),
