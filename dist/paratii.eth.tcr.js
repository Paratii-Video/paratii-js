...
var ParatiiEthTcr = exports.ParatiiEthTcr = function () {
  ...
  (0, _createClass3.default)(ParatiiEthTcr, [{
    ...
    value: function revealVote(pollID, voteOption, salt) {
      ...
      return _regenerator2.default.async(function revealVote$(_context36) {
        while (1) {
    ...
    value: function revealPeriodActive(pollID) {
      ...
      return _regenerator2.default.async(function revealPeriodActive$(_context37) {
        while (1) {
          switch (_context37.prev = _context37.next) {
            ...
            case 5:
              ...
              return _context37.abrupt('return', isRevealPeriodActive);
    ...
    value: function didCommit(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function didCommit$(_context38) {
        while (1) {
          switch (_context38.prev = _context38.next) {
            ...
            case 5:
              didCommit = _context38.sent;
              return _context38.abrupt('return', didCommit);
    ...
    value: function didReveal(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function didReveal$(_context39) {
        while (1) {
          switch (_context39.prev = _context39.next) {
            ...
            case 5:
              didReveal = _context39.sent;
              return _context39.abrupt('return', didReveal);
    ...
    value: function getCommitHash(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function getCommitHash$(_context40) {
        while (1) {
          switch (_context40.prev = _context40.next) {
            ...
            case 5:
              commitHash = _context40.sent;
              return _context40.abrupt('return', commitHash);
    ...
    value: function isPassed(pollID) {
      ...
      return _regenerator2.default.async(function isPassed$(_context41) {
        while (1) {
          switch (_context41.prev = _context41.next) {
            ...
            case 5:
              didPass = _context41.sent;
              return _context41.abrupt('return', didPass);
    ...
    value: function getNumPassingTokens(voterAddress, pollID, salt) {
      ...
      return _regenerator2.default.async(function getNumPassingTokens$(_context42) {
        while (1) {
          switch (_context42.prev = _context42.next) {
            ...
            case 5:
              winnings = _context42.sent;
              return _context42.abrupt('return', winnings);
    ...
    value: function validPosition(prevPollID, nextPollID, voter, amount) {
      ...
      return _regenerator2.default.async(function validPosition$(_context43) {
        while (1) {
    ...
    value: function getNumTokens(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function getNumTokens$(_context44) {
        while (1) {
          switch (_context44.prev = _context44.next) {
            ...
            case 5:
              numTokens = _context44.sent;
              return _context44.abrupt('return', numTokens);
    ...
    value: function requestVotingRights(amount) {
      ...
      return _regenerator2.default.async(function requestVotingRights$(_context45) {
        while (1) {
    ...
    value: function withdrawVotingRights(amount) {
      ...
      return _regenerator2.default.async(function withdrawVotingRights$(_context46) {
        while (1) {
    ...
    value: function rescueTokens(pollID) {
      ...
      return _regenerator2.default.async(function rescueTokens$(_context47) {
        while (1) {
    ...
    value: function isExpired(deadline) {
      ...
      return _regenerator2.default.async(function isExpired$(_context48) {
        while (1) {
          switch (_context48.prev = _context48.next) {
            ...
            case 5:
              isExpired = _context48.sent;
              return _context48.abrupt('return', isExpired);
    ...
    value: function getLockedTokens(voterAddress) {
      ...
      return _regenerator2.default.async(function getLockedTokens$(_context49) {
        while (1) {
          switch (_context49.prev = _context49.next) {
            ...
            case 6:
              lockedTokens = _context49.sent;
              return _context49.abrupt('return', lockedTokens);
    ...
    value: function commitPeriodActive(pollID) {
      ...
      return _regenerator2.default.async(function commitPeriodActive$(_context50) {
        while (1) {
          switch (_context50.prev = _context50.next) {
            ...
            case 5:
              isCommitPeriodActive = _context50.sent;
              return _context50.abrupt('return', isCommitPeriodActive);
    ...
    value: function isInApplyStage(videoId) {
      ...
      return _regenerator2.default.async(function isInApplyStage$(_context51) {
        while (1) {
          switch (_context51.prev = _context51.next) {
            ...
            case 2:
              listing = _context51.sent;
              _context51.next = 5;
              return _regenerator2.default.awrap(this.eth.web3.eth.getBlock('latest'));

            case 5:
              latestBlock = _context51.sent;
              return _context51.abrupt('return', listing.applicationExpiry > latestBlock.timestamp);
    ...
    value: function getLastNode(voter) {
      ...
      return _regenerator2.default.async(function getLastNode$(_context52) {
        while (1) {
          switch (_context52.prev = _context52.next) {
            ...
            case 6:
              lastNode = _context52.sent;
              return _context52.abrupt('return', lastNode);
