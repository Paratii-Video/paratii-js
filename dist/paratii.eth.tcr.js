...
var ParatiiEthTcr = exports.ParatiiEthTcr = function () {
  ...
  (0, _createClass3.default)(ParatiiEthTcr, [{
    ...
    value: function approveAndStartChallenge(videoId, _data) {
      ...
      return _regenerator2.default.async(function approveAndStartChallenge$(_context31) {
        while (1) {
    ...
    value: function startChallenge(videoId, _data) {
      ...
      return _regenerator2.default.async(function startChallenge$(_context32) {
        while (1) {
          switch (_context32.prev = _context32.next) {
            ...
            case 23:
              appWasMade = _context32.sent;
              _context32.next = 26;
              return _regenerator2.default.awrap(this.isWhitelisted(videoId));

            case 26:
              isWhitelisted = _context32.sent;
            ...
            case 39:
              return _context32.abrupt('return', pollID);
    ...
    value: function updateStatus(videoId) {
      ...
      return _regenerator2.default.async(function updateStatus$(_context33) {
        while (1) {
    ...
    value: function claimReward(videoId, salt) {
      ...
      return _regenerator2.default.async(function claimReward$(_context34) {
        while (1) {
    ...
    key: 'requestRightsAndCommitVote',
    value: function requestRightsAndCommitVote(videoId, vote, amountInWei) {
      var tcrPLCRVoting, listing, challengeExists, isCommitPeriodActive, approved, commitVoteTx;
      return _regenerator2.default.async(function requestRightsAndCommitVote$(_context35) {
        while (1) {
          switch (_context35.prev = _context35.next) {
            ...
            case 8:
              challengeExists = _context35.sent;
            ...
            case 25:
              commitVoteTx = _context35.sent;
              return _context35.abrupt('return', commitVoteTx);
    ...
    value: function commitVote(videoId, vote, amountInWei) {
      ...
      return _regenerator2.default.async(function commitVote$(_context36) {
        while (1) {
          switch (_context36.prev = _context36.next) {
            ...
            case 25:
              hasVotingRights = _context36.sent;
    ...
    value: function revealVote(pollID, voteOption, salt) {
      ...
      return _regenerator2.default.async(function revealVote$(_context37) {
        while (1) {
          switch (_context37.prev = _context37.next) {
            ...
            case 5:
              isRevealPeriodActive = _context37.sent;
    ...
    value: function revealPeriodActive(pollID) {
      ...
      return _regenerator2.default.async(function revealPeriodActive$(_context38) {
        while (1) {
          switch (_context38.prev = _context38.next) {
            ...
            case 5:
              isRevealPeriodActive = _context38.sent;
              return _context38.abrupt('return', isRevealPeriodActive);
    ...
    value: function didCommit(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function didCommit$(_context39) {
        while (1) {
          switch (_context39.prev = _context39.next) {
            ...
            case 5:
              didCommit = _context39.sent;
              return _context39.abrupt('return', didCommit);
    ...
    value: function didReveal(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function didReveal$(_context40) {
        while (1) {
          switch (_context40.prev = _context40.next) {
            ...
            case 5:
              didReveal = _context40.sent;
              return _context40.abrupt('return', didReveal);
    ...
    value: function getCommitHash(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function getCommitHash$(_context41) {
        while (1) {
          switch (_context41.prev = _context41.next) {
            ...
            case 5:
              commitHash = _context41.sent;
              return _context41.abrupt('return', commitHash);
    ...
    value: function isPassed(pollID) {
      ...
      return _regenerator2.default.async(function isPassed$(_context42) {
        while (1) {
          switch (_context42.prev = _context42.next) {
            ...
            case 5:
              didPass = _context42.sent;
              return _context42.abrupt('return', didPass);
    ...
    value: function getNumPassingTokens(voterAddress, pollID, salt) {
      ...
      return _regenerator2.default.async(function getNumPassingTokens$(_context43) {
        while (1) {
          switch (_context43.prev = _context43.next) {
            ...
            case 5:
              winnings = _context43.sent;
              return _context43.abrupt('return', winnings);
    ...
    value: function validPosition(prevPollID, nextPollID, voter, amount) {
      ...
      return _regenerator2.default.async(function validPosition$(_context44) {
        while (1) {
    ...
    value: function getNumTokens(voterAddress, pollID) {
      ...
      return _regenerator2.default.async(function getNumTokens$(_context45) {
        while (1) {
          switch (_context45.prev = _context45.next) {
            ...
            case 5:
              numTokens = _context45.sent;
              return _context45.abrupt('return', numTokens);
    ...
    value: function requestVotingRights(amount) {
      ...
      return _regenerator2.default.async(function requestVotingRights$(_context46) {
        while (1) {
    ...
    value: function hasVotingRights(amount) {
      ...
      return _regenerator2.default.async(function hasVotingRights$(_context47) {
        while (1) {
          switch (_context47.prev = _context47.next) {
            ...
            case 2:
              PLCRVoting = _context47.sent;
              _context47.next = 5;
              return _regenerator2.default.awrap(PLCRVoting.methods.voteTokenBalance(this.eth.getAccount()).call());

            case 5:
              numTokens = _context47.sent;
              return _context47.abrupt('return', numTokens >= amount);
    ...
    value: function withdrawVotingRights(amount) {
      ...
      return _regenerator2.default.async(function withdrawVotingRights$(_context48) {
        while (1) {
    ...
    value: function rescueTokens(pollID) {
      ...
      return _regenerator2.default.async(function rescueTokens$(_context49) {
        while (1) {
    ...
    value: function isExpired(deadline) {
      ...
      return _regenerator2.default.async(function isExpired$(_context50) {
        while (1) {
          switch (_context50.prev = _context50.next) {
            ...
            case 5:
              isExpired = _context50.sent;
              return _context50.abrupt('return', isExpired);
    ...
    value: function getLockedTokens(voterAddress) {
      ...
      return _regenerator2.default.async(function getLockedTokens$(_context51) {
        while (1) {
          switch (_context51.prev = _context51.next) {
            ...
            case 3:
              tcrPLCRVoting = _context51.sent;
              _context51.next = 6;
              return _regenerator2.default.awrap(tcrPLCRVoting.methods.getLockedTokens(voterAddress).call());

            case 6:
              lockedTokens = _context51.sent;
              return _context51.abrupt('return', lockedTokens);
    ...
    value: function commitPeriodActive(pollID) {
      ...
      return _regenerator2.default.async(function commitPeriodActive$(_context52) {
        while (1) {
          switch (_context52.prev = _context52.next) {
            ...
            case 2:
              tcrPLCRVoting = _context52.sent;
              _context52.next = 5;
              return _regenerator2.default.awrap(tcrPLCRVoting.methods.commitPeriodActive(pollID).call());

            case 5:
              isCommitPeriodActive = _context52.sent;
              return _context52.abrupt('return', isCommitPeriodActive);
    ...
    value: function isInApplyStage(videoId) {
      ...
      return _regenerator2.default.async(function isInApplyStage$(_context53) {
        while (1) {
          switch (_context53.prev = _context53.next) {
            ...
            case 2:
              listing = _context53.sent;
              _context53.next = 5;
              return _regenerator2.default.awrap(this.eth.web3.eth.getBlock('latest'));

            case 5:
              latestBlock = _context53.sent;
              return _context53.abrupt('return', listing.applicationExpiry > latestBlock.timestamp);
    ...
    value: function getLastNode(voter) {
      ...
      return _regenerator2.default.async(function getLastNode$(_context54) {
        while (1) {
          switch (_context54.prev = _context54.next) {
            ...
            case 3:
              tcrPLCRVoting = _context54.sent;
              _context54.next = 6;
              return _regenerator2.default.awrap(tcrPLCRVoting.methods.getLastNode(voter).call());

            case 6:
              lastNode = _context54.sent;
              return _context54.abrupt('return', lastNode);
